...
ARG ARG_REACT_APP_CLIENT_LOGO
ENV REACT_APP_CLIENT_LOGO $ARG_REACT_APP_CLIENT_LOGO
ARG ARG_REACT_APP_CLIENT_LOGO_LINK
ENV REACT_APP_CLIENT_LOGO_LINK $ARG_REACT_APP_CLIENT_LOGO_LINK
ARG ARG_REACT_APP_POLUS_LOGO
ENV REACT_APP_POLUS_LOGO $ARG_REACT_APP_POLUS_LOGO
ARG ARG_REACT_APP_POLUS_LOGO_LINK
ENV REACT_APP_POLUS_LOGO_LINK $ARG_REACT_APP_POLUS_LOGO_LINK
ARG ARG_REACT_APP_SPHINX_LOGO
ENV REACT_APP_SPHINX_LOGO $ARG_REACT_APP_SPHINX_LOGO
ARG ARG_REACT_APP_SPHINX_LOGO_LINK
ENV REACT_APP_SPHINX_LOGO_LINK $ARG_REACT_APP_SPHINX_LOGO_LINK
